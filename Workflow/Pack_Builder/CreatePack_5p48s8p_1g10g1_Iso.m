...
batt_5p12s_1g10g1 = Module(ParallelAssembly=pSet, ...
    NumSeriesAssemblies=12);


% Define grouping to control fidelity
batt_5p12s_1g10g1.SeriesGrouping   = [1,10,1]; % Unique behavior at ends of series 
batt_5p12s_1g10g1.ParallelGrouping = [1,1,1];  % Same behavior for all cells at ends 
...
ModuleChart = BatteryChart(Parent = h1_5p12s_1g10g1,...
    Battery=batt_5p12s_1g10g1, SimulationStrategyVisible = "On");
xlabel('X');ylabel('Y'); 
...
batt_5p48s_1g10g1 = ModuleAssembly(...
    Module = repmat(batt_5p12s_1g10g1,1,4),...
    StackingAxis="X");
...
batt_5p48s8p_1g10g1 = Pack(...
    ModuleAssembly=repmat(batt_5p48s_1g10g1,1,8),...
...
if(~exist('+pack_5p48s8p_1g10g1_Iso','dir'))
    buildBattery(batt_5p48s8p_1g10g1,...
        "LibraryName","pack_5p48s8p_1g10g1_Iso",...
