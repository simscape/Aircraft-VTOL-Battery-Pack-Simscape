...
batt_5p12s_1g10g1_thr = Module(ParallelAssembly=pSet_thr, ...
    CoolingPlate = "Bottom",...
    NumSeriesAssemblies=12);

% Define grouping to control fidelity
batt_5p12s_1g10g1_thr.SeriesGrouping   = [1,10,1]; % Unique behavior at ends of series 
batt_5p12s_1g10g1_thr.ParallelGrouping = [1,1,1];  % Same behavior for all cells at ends 

% Reuse figure if it exists for battery chart
if ~exist('h1_5p12s_1g10g1', 'var') || ...
        ~isgraphics(h1_5p12s_1g10g1, 'figure')
    h1_5p12s_1g10g1 = figure('Name', 'h1_5p12s_1g10g1');
end
figure(h1_5p12s_1g10g1); clf(h1_5p12s_1g10g1)

% Create chart
ModuleChart = BatteryChart(Parent = h1_5p12s_1g10g1,...
    Battery=batt_5p12s_1g10g1_thr, SimulationStrategyVisible = "On");
xlabel('X');ylabel('Y'); 
...
batt_5p48s_1g10g1_thr = ModuleAssembly(...
    Module = repmat(batt_5p12s_1g10g1_thr,1,4),...
...
% Reuse figure if it exists for battery chart
if ~exist('h1_5p48s_1g10g1', 'var') || ...
        ~isgraphics(h1_5p48s_1g10g1, 'figure')
    h1_5p48s_1g10g1 = figure('Name', 'h1_5p48s_1g10g1');
end
figure(h1_5p48s_1g10g1); clf(h1_5p48s_1g10g1)

% Create chart
BatteryChart(Parent = h1_5p48s_1g10g1,...
    Battery = batt_5p48s_1g10g1_thr, ...
...
batt_5p48s8p_1g10g1_thr = Pack(...
    ModuleAssembly=repmat(batt_5p48s_1g10g1_thr,1,8),...
...
% Reuse figure if it exists for battery chart
if ~exist('h1_5p48s8p_1g10g1', 'var') || ...
        ~isgraphics(h1_5p48s8p_1g10g1, 'figure')
    h1_5p48s8p_1g10g1= figure('Name', '5p48s8p_1g10g1');
end
figure(h1_5p48s8p_1g10g1); clf(h1_5p48s8p_1g10g1)

% Create chart
BatteryChart(Parent = h1_5p48s8p_1g10g1,...
    Battery = batt_5p48s8p_1g10g1_thr, ...
    SimulationStrategyVisible = "On");
xlabel('X');ylabel('Y'); 
...
if(~exist('+pack_5p48s8p_1g10g1_Thr','dir'))
    buildBattery(batt_5p48s8p_1g10g1_thr,...
        "LibraryName","pack_5p48s8p_1g10g1_Thr",...
